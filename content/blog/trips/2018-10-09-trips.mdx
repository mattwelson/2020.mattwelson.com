...
## Update 
While I did use popmotion pose for the animations, this library has now been replaced by Framer Motion, which is now
pretty well tested and works equally well. 
